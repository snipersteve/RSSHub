...
// 发现报告
router.get('/stock/fxbg', lazyloadRouteHandler('./routes/stock/fxbg'));
...
router.get('/bjx/zhengce', lazyloadRouteHandler('./routes/bjx/zhengce'));

// 中国储能网
router.get('/escn/zhengce', lazyloadRouteHandler('./routes/escn/zhengce'));
...
// 康达律师事务所文章
router.get('/law/kd', lazyloadRouteHandler('./routes/law/kd'));

// 反垄断局
router.get('/law/jyzjzjyajgs', lazyloadRouteHandler('./routes/law/jyzjzjyajgs'));
router.get('/law/jyzjzwtjpz', lazyloadRouteHandler('./routes/law/jyzjzwtjpz'));
router.get('/law/jyzjzftjpz', lazyloadRouteHandler('./routes/law/jyzjzftjpz'));
router.get('/law/fldxzcf', lazyloadRouteHandler('./routes/law/fldxzcf'));

// 财政部通知公告
router.get('/law/czb', lazyloadRouteHandler('./routes/law/czb'));

// 各省能源局
router.get('/law/jxnyj', lazyloadRouteHandler('./routes/law/jxnyj'));
router.get('/law/nmnyj', lazyloadRouteHandler('./routes/law/nmnyj'));
router.get('/law/hnnyj', lazyloadRouteHandler('./routes/law/hnnyj'));
router.get('/law/gdnyj', lazyloadRouteHandler('./routes/law/gdnyj'));
router.get('/law/jsnyj', lazyloadRouteHandler('./routes/law/jsnyj'));
