...
// 发现报告
router.get('/stock/fxbg', require('./routes/stock/fxbg'));
...
//中国储能网
router.get('/escn/zhengce', require('./routes/escn/zhengce'));
...
// 反垄断局
router.get('/law/jyzjzjyajgs', require('./routes/law/jyzjzjyajgs'));
router.get('/law/jyzjzwtjpz', require('./routes/law/jyzjzwtjpz'));
router.get('/law/jyzjzftjpz', require('./routes/law/jyzjzftjpz'));
router.get('/law/fldxzcf', require('./routes/law/fldxzcf'));

//财政部通知公告
router.get('/law/czb', require('./routes/law/czb'));
